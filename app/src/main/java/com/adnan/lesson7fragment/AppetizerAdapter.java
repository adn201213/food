...
public class AppetizerAdapter extends RecyclerView.Adapter<AppetizerAdapter.FoodHolder>{
...
private Context context;
    ...
    public AppetizerAdapter(ArrayList<Appetizer> appetizers, Context context, RecyclerViewClick recyclerViewClick) {
    ...
    Appetizer appetizer=appetizers.get(position);

            holder.imageView.setImageResource(appetizer.getAppetizerImage());
            holder.textView.setText(appetizer.getAppetizerName());
