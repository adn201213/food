...
public class FoodFragment extends Fragment {
    ...
    private FoodFireBaseAdapter foodAdapter;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        FloatingActionButton floatingActionButton = view.findViewById(R.id.fragment_food_floatbtn_addfood);
    ...
    private void setUpRecyclerView(View view) {
        ...
        Query query1 = query.whereEqualTo("foodType", "Food");
        ...
        recyclerView = view.findViewById(R.id.fragment_food_rv_food_list);
